...
const Login = () => {
  ...
  return (
    <div className=" h-full w-full flex flex-col">
      <div className="h-[10%] text-6xl font-bold flex justify-center">
      ...
      <div className=' h-[90%] flex justify-center items-center'>
        <div className=" min-w-96 h-[50%] flex justify-center items-center">
          <div className='p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-10 border border-gray-100'>
            ...
            <form onSubmit={onSubmitHandler} action="">
              ...
              <p className='text-center my-2'>
                ...
                <Link to="/signup" className='btn btn-sm mt-2 border border-slate-700'>
                  SignUp
                </Link>
              </p>
              <div>
